import { ht as __vitePreload } from "./index-COr1gJpN.js";
...
async function call(client, args) {
	...
	try {
		...
		const { offchainLookup, offchainLookupSignature } = await __vitePreload(async () => {
			const { offchainLookup: offchainLookup$1, offchainLookupSignature: offchainLookupSignature$1 } = await import("./ccip-DM9f7irm.js");
			return {
