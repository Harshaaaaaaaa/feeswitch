...
async function recoverPublicKey({ hash, signature }) {
	...
	const { secp256k1: secp256k1$1 } = await __vitePreload(async () => {
		const { secp256k1: secp256k1$2 } = await import("./secp256k1-JLYszVlB.js");
